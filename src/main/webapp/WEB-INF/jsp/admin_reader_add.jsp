        ...
        <div class="panel-body">
            <form action="reader_add_do.html" method="post" id="readeredit" >
                ...
                <script>
                    ...
                    document.getElementById("readeredit").addEventListener("submit", function(event) {
                        if (document.getElementById("password").value == '' || document.getElementById("name").value == '' || document.getElementById("sex").value == '' || document.getElementById("birth").value == '' || document.getElementById("address").value == '' || document.getElementById("phone").value == '') {
                            alert("请填入完整读者信息！");
