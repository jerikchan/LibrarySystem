...
<script>
    document.addEventListener("keyup", function() {
        ...
        var reNewPasswd = document.getElementById("reNewPasswd").value;
        var tishi = document.getElementById("tishi");
        
        if (newPasswd !== reNewPasswd && newPasswd !== "" && reNewPasswd !== "" && newPasswd.length === reNewPasswd.length) {
            tishi.textContent = "两次输入的新密码不同，请检查";
        } else {
            tishi.textContent = "";
        }
    });
    document.getElementById("repasswd").addEventListener("submit", function () {
        if (document.getElementById("oldPasswd").value == '' || document.getElementById("newPasswd").value == '' || document.getElementById("reNewPasswd").value == '') {
            document.getElementById("tishi").textContent = "请填写完毕后提交";
            return false;
        } else if (document.getElementById("newPasswd").value != document.getElementById("reNewPasswd").value) {
            document.getElementById("tishi").textContent = "两次输入的新密码不同，请检查";
            return false;
        }
    });
